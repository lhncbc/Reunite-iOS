...
@implementation PLgetEventDataResponseType
...
- (id) initWithNode: (CXMLNode*) node {
    ...
    {
        self.eventList = [Soap getNodeValue: node withName: @"events"];
...
{
    return [self serialize: @"getEventDataResponseType"];
}
...
- (NSMutableString*) serializeElements
{
    ...
    if (self.eventList != nil) [s appendFormat: @"<events>%@</events>", [CommonFunctions escapeForXML:self.eventList]];
...
- (BOOL)isEqual:(id)object{
    if(object != nil && [object isKindOfClass:[PLgetEventDataResponseType class]]) {
